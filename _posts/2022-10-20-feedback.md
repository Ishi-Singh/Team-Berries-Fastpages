...
<script>
  ...
  const like_url = url + "/yes/";  // haha reaction
  const jeer_url = url + "/no/";  // boohoo reaction
      ...
      response.json().then(data => {
          ...
          for (const row of data) {
            ...
            const haha = document.createElement("td");
              ...
              haha_but.innerHTML = row.yes;  // add fetched "haha count" to innerHTML
            ...
            const boohoo = document.createElement("td");
              ...
              boohoo_but.innerHTML = row.no;  // add fetched "boohoo count" to innerHTML
